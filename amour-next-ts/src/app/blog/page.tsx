        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mb-12 animate-fade-in">
              <Badge className="mb-4 bg-amber-600 text-white">Featured Article</Badge>
              <Card className="border shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
                <div className="md:flex">
                  ...
                  <div className="md:w-1/2 p-8">
                    <Badge className="mb-3 bg-amber-100 text-amber-800">{featuredPost.category}</Badge>
                  ...
                  .map((post, index) => (
                    ...
                    >
                      ...
                      <CardContent className="p-6">
                        <Badge className="mb-3 bg-amber-100 text-amber-800">{post.category}</Badge>
                  ...
                  {categories.map((category, index) => (
                    <div
                      ...
                      className={`flex items-center justify-between p-2 rounded-lg cursor-pointer transition-colors duration-200 ${
                        category.active ? "bg-amber-600 text-white" : "hover:bg-gray-50"
                      }`}
                    >
            ...
            <Card className="border shadow-sm mb-8 animate-slide-up stagger-2">
              ...
              <CardContent className="pt-0">
                ...
                <div className="space-y-3">
                  ...
                  />
                  <Button className="w-full bg-amber-600 hover:bg-amber-700 text-sm">Subscribe</Button>
                </div>
              </CardContent>
            </Card>
                    ...
                    <div key={index} className="flex space-x-3 group cursor-pointer">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                          ...
                          <span className="text-xs text-amber-600">{post.readTime}</span>
                        </div>
                      </div>
                    </div>
                  ))}
